...
* **Git-like Workflow**: Uses a ``.pt`` directory structure for backups, mirroring Git's approach.
...
* **Diff Support**: Compare files with their backups using external tools like `delta <https://github.com/dandavison/delta>`_.
